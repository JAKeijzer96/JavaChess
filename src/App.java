...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        // Game singleCheckUnpin = new Game("rnbqr1n1/ppppbppp/7k/2p5/2P5/2P5/PPPP2PP/RNBQKBNR b KQ - 0 1");
        // singleCheckUnpin.makeMove("e7", "f6");
        // Game doubleCheckUnpin = new Game("rnbqr1n1/ppppbppp/7k/2p5/2P5/2P5/PPPP2PP/RNBQKBNR b KQ - 0 1");
        // doubleCheckUnpin.makeMove("e7", "h4");
        // Game doubleCheckKnightUnpin = new Game("8/3r4/8/3n4/8/3K4/8/7k b - - 0 1");
        // doubleCheckKnightUnpin.makeMove("d5", "f4");
        // Game noKingMovesNoCapture = new Game("rnbqkbnr/ppp1pppp/4p3/8/2Q5/8/PPPPPPPP/RNB1KBNR w KQkq - 0 1");
        // noKingMovesNoCapture.makeMove("c4", "b5");
        // Game noKingMovesCanCapture = new Game("rnbqkbnr/ppp1pppp/4p3/8/2Q5/8/PPPPPPPP/RNB1KBNR w KQkq - 0 1");
        // noKingMovesCanCapture.makeMove("c4", "c6");
        // Game takeOrMoveAfterCheck = new Game("rb1qkb1r/pppppppp/8/8/7n/8/PPP3PP/RNBQKBNR b KQkq - 0 1");
        // takeOrMoveAfterCheck.makeMove("h4", "f3");
        // Game moveKingDownLeft = new Game("8/8/8/R7/3k3K/1P6/4R3/5R2 w - - 0 1");
        // moveKingDownLeft.makeMove("f1", "d1");
        Game unpinNoCheckBefore = new Game("8/5k2/5r2/R7/7K/1P6/4R3/5R2 b - - 0 1");
